...
# 測定データ
f = np.array(
    [10, 25, 35, 42, 46, 48, 50, 52, 54, 58, 65, 75, 90, 110, 150], dtype=float
)  # kHz
y = np.array(
    [
        0.06097,
...
popt, pcov = curve_fit(
    amp_model, f, y, p0=[0.86, 50.4, 3.0], bounds=([0, 40, 0.1], [2, 70, 20])
)
...
popt_phase, pcov_phase = curve_fit(
    phase_model, f, phase, p0=[50.4, 3.0], bounds=([40, 0.1], [70, 20])
)
